...
Note: Comes with additional helper methods to handle Android text input through the software keyboard. You'll need it if your app takes any kind of input from the user, as Heaps doesn't have support for this by default.
